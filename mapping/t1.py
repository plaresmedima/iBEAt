...
def T1_fitting(images_to_be_fitted, TI, sequenceParam):
    ...
    popt, pcov = curve_fit(lambda TI, M_eq, T1,FA_Eff: signalSequenceT1_FLASH(M_eq, T1, TI, FA,FA_Eff, TR, N,FA_Cat), xdata = TI, ydata = images_to_be_fitted, p0=initial_guess, bounds=(lb,ub), method='trf',maxfev=1000)
